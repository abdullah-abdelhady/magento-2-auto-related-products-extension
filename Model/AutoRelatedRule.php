 ...
 */
namespace Sparsh\AutoRelatedProducts\Model;
 ...
 * @link     https://www.sparsh-technologies.com
 */
class AutoRelatedRule extends AbstractModel implements \Sparsh\AutoRelatedProducts\Api\Data\AutoRelatedRuleInterface
{
    /**
     ...
     * @var string
     */
    protected $_eventPrefix = 'sparsh_auto_related_products';
    ...
    public function __construct(
        ...
        \Sparsh\AutoRelatedProducts\Model\ResourceModel\AutoRelatedRule $ruleResourceModel,
    ...
    {
        parent::_construct();
        $this->_init(\Sparsh\AutoRelatedProducts\Model\ResourceModel\AutoRelatedRule::class);
