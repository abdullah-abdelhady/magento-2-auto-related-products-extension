...
class Chooser extends Multiselect
{
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<div id="sparsh-auto-related-products-category-select" 
            class="admin__field" 
            data-bind="scope:\'sparshAutoRelatedProductsCategory\'" 
            data-index="index">';
        ...
        $html = '<script type="text/x-magento-init">
            {
                "*": {
                    "Magento_Ui/js/core/app": {
                        "components": {
                            "sparshAutoRelatedProductsCategory": {
                                "component": "uiComponent",
                                "children": {
                                    "select_category": {
                                        "component": "Sparsh_AutoRelatedProducts/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
