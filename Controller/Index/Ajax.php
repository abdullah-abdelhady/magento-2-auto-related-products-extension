 ...
 */
namespace Sparsh\AutoRelatedProducts\Controller\Index;
                ...
                if (count($ruleCollection)) {
                    foreach ($ruleCollection as $rule) {
                        ...
                        $output = $resultPage->getLayout()
                            ->createBlock(\Sparsh\AutoRelatedProducts\Block\ProductList\AutoRelated::class)
                            ->setData('rule', $rule)
                            ->setData('rule_id', $this->getRequest()->getParam('rule_id'))
                            ->setData('mode', DisplayModes::AJAX)
                            ->setTemplate('Sparsh_AutoRelatedProducts::auto_related_products_rules.phtml')
                            ->toHtml();
