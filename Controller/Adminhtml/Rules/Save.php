 ...
 * @link     https://www.sparsh-technologies.com
 */
class Save extends \Sparsh\AutoRelatedProducts\Controller\Adminhtml\Rules\Rule
{
    /**
     * Rule save action
     *
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($validateResult !== true) {
                ...
                $this->_redirect('sparsh_auto_related_products/rules/edit', ['id' => $model->getId()]);
                return;
            }
            ...
            if ($this->getRequest()->getParam('back')) {
                $this->_redirect('sparsh_auto_related_products/rules/edit', ['id' => $model->getId(), 'type' => $model->getRuleType()]);
                return;
            }
            $this->_redirect('sparsh_auto_related_products/rules/');
            return;
            ...
            $this->_session->setPageData($data);
            $this->_redirect(
                'sparsh_auto_related_products/rules/edit',
                [
                    'id' => $this->getRequest()->getParam('rule_id'),
                    'type' => $data['rule_type']
                ]
